...
latex_documents = [
    ('index',
     ...
     u"Repo criado para o curso de mlops deploy alura", 'manual'),
]
...
man_pages = [
    ('index', 'mlops-deploy', u'mlops-deploy Documentation',
     [u"Repo criado para o curso de mlops deploy alura"], 1)
]
...
texinfo_documents = [
    ('index', 'mlops-deploy', u'mlops-deploy Documentation',
     u"Repo criado para o curso de mlops deploy alura", 'mlops-deploy',
